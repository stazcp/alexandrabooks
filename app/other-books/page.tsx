    ...
    <div className="min-h-screen bg-[#f0f0f0] text-gray-800 pattern-bg">
      <div className="container mx-auto px-4 py-6 relative z-10">
        ...
        <header className="flex flex-col items-center mb-12">
          <h1 className="text-5xl md:text-6xl font-black text-gray-800 mb-4 text-center tracking-tight">OTHER BOOKS</h1>
        ...
        <section className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-xl p-8 md:p-10 shadow-lg doodle-border">
            <p className="text-lg text-gray-700 mb-6 leading-relaxed text-center">
              Explore other works by Alexandra Psaropoulou, featuring her unique blend of visual poetry and spiritual
              exploration beyond The Flying series.
            </p>
          </div>
        </section>

        <section className="max-w-6xl mx-auto mb-16">
          {/* Dynamic book grid filtered to "Other Works" series */}
          <BookGrid series="Other Works" />
        </section>
        ...
        <section className="max-w-6xl mx-auto">
          <div className="bg-white rounded-xl p-8 md:p-10 shadow-lg doodle-border text-center">
            ...
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              Alexandra's creative vision extends beyond The Flying series, offering readers diverse pathways to
